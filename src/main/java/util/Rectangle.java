...
public boolean equals(Object o) {
  ...
  public Point centre() {
    ...
    /**
     * Return the inner-distance between a rectangle and a point.
     *
     *
     * @param minX minimum X coordinate of rectangle
     * @param minY minimum Y coordinate of rectangle
     ...
     * @param pY Y coordinate of point
     *
     * @return Inner-distance beween this rectangle and the passed point.
     */
  public static double innerDistance(float minX, float minY, float maxX,
